      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-white/80 dark:bg-[#0f1129]/90 backdrop-blur-xl shadow-lg shadow-slate-200/50 dark:shadow-slate-900/50 py-3' : 'bg-transparent py-6'}`}>
        <div className="max-w-[1400px] mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center group cursor-pointer">
            <img src="/images/logo-white.png" alt="Print room" className={`h-20 w-auto group-hover:scale-105 transition-all duration-300 ${isScrolled ? 'invert dark:invert-0' : ''}`} />
          </div>
      ...
      <section id="proces" className="py-24 md:py-32 bg-white dark:bg-[#0f1129] relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="bg-[#0a0e27] aspect-square rounded-3xl overflow-hidden relative group shadow-2xl shadow-blue-900/20 ring-2 ring-white/15 backdrop-blur-sm">
              <img
